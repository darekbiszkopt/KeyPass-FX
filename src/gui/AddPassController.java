...
public class AddPassController implements Initializable {
    ...
    public void Add(){
        ...
        if( loginTextfield.getText().trim().length() < 1 || sourceTextfield.getText().trim().length() < 1 || passwordTextfield.getText().trim().length() < 1)
        {
        ...
        {
            mainController.getTableList().add(new PasswordItem(loginTextfield.getText(),passwordTextfield.getText(), sourceTextfield.getText()));
            getStage().close();
        }
